...
#define stepsMotorPerRev 288     //Motor steps per revolution, including gear reduction (Default value : 288 steps/rev)

#define microsteps 32             //Driver microsteps (Default value 32)
